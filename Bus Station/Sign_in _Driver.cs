...
namespace Bus_Station
{
    public partial class Form3 : MetroFramework.Forms.MetroForm
    {
        ...
        private void Submit_Click(object sender, EventArgs e)
        {
            ...
            //dataBase.connect();
            string query = "INSERT INTO  Driver  ( driver_username,driver_password,phoneNum,driver_email,Adress) VALUES(@driver_username,@driver_password,@phoneNum,@driver_email,@Adress) ";
            ...
            command.Parameters.AddWithValue("@Adress", metroTextBox7.Text);

...
namespace Bus_Station
{
    public partial class Passanger : MetroFramework.Forms.MetroForm
    {
        ...
        private void roundButton_Click(object sender, EventArgs e)
        {
            ...
            if (!v.chechMails(metroTextBox4.Text.ToString()))
            {
                MetroFramework.MetroMessageBox.Show(this, " Your E-Mail is not valid ", " Sorry", MessageBoxButtons.OK);

            }
            else if (metroTextBox2.Text != metroTextBox3.Text)
            {

                MetroFramework.MetroMessageBox.Show(this, " Your Password is not Identical  ", "Sorry " + metroTextBox1.Text, MessageBoxButtons.OK);

            }
           
            else if ( !v.checkPhoneNum(metroTextBox5.Text.ToString()))
            {
                MetroFramework.MetroMessageBox.Show(this, " Your Phone is not valid ", " Sorry", MessageBoxButtons.OK);
            }
            else if(metroComboBox1.Text.ToString() == "" )
            {
                MetroFramework.MetroMessageBox.Show(this, " Your City is not valid ", " Sorry", MessageBoxButtons.OK);
            }
            else
            {
                MetroFramework.MetroMessageBox.Show(this, " Your Register is sucessful  ", "Welcome " + metroTextBox1.Text, MessageBoxButtons.OK);
